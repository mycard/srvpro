...
(function() {
  ...
  Room = (function() {
    ...
    Room.prototype["delete"] = function() {
      var challonge_duel_log, end_time, index, log_rep_id, name, player_ips, player_names, recorder_buffer, ref2, replay_id, score, score_array;
      if (this.deleted) {
        return;
      }
      score_array = [];
  ...
  ygopro.stoc_follow('GAME_MSG', true, function(buffer, info, client, server) {
    var card, count, cpos, hint_type, len2, line, loc, m, msg, oppo_pos, phase, playertype, pos, ppos, reason, ref2, ref3, ref4, room, trigger_location, val, win_pos;
    room = ROOM_all[client.rid];
    if (!(room && !client.reconnecting)) {
      return;
    }
