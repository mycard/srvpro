...
(function() {
  ...
  Room = (function() {
    function Room(name, hostinfo) {
      var draw_count, lflist, param, proc_bin_name, proc_bin_path, rule, start_hand, start_lp, time_limit;
      ...
      try {
        this.process = spawn(proc_bin_name, param, {
          cwd: proc_bin_path
        });
  ...
  ygopro.ctos_follow('JOIN_GAME', false, function(buffer, info, client, server) {
    var check, decrypted_buffer, finish, i, id, len3, len4, m, n, name, ref3, ref4, replay_id, room, secret;
    ...
    if (settings.modules.stop) {
      ...
      finish = function(buffer) {
        var action, len3, m, name, opt1, opt2, opt3, options, ref3, room, title;
  ...
  ygopro.stoc_follow('JOIN_GAME', false, function(buffer, info, client, server) {
    ...
    if (settings.modules.cloud_replay.enable_halfway_watch && !settings.modules.ygosharp.enabled && !room.watcher) {
  ...
  ygopro.stoc_follow('GAME_MSG', true, function(buffer, info, client, server) {
    var card, count, len3, line, loc, m, msg, oppo_pos, phase, playertype, pos, reason, ref3, ref4, ref5, room, trigger_location, val, win_pos;
    room = ROOM_all[client.rid];
    if (!room) {
      return;
    }
  ...
  ygopro.ctos_follow('UPDATE_DECK', true, function(buffer, info, client, server) {
    var buff_main, buff_side, card, current_deck, deck, deck_array, deck_main, deck_side, deck_text, deckbuf, decks, found_deck, i, len3, len4, line, m, n, oppo_pos, room, struct, win_pos;
    room = ROOM_all[client.rid];
    if (!room) {
      return false;
    }
  ...
  if (settings.modules.http) {
    ...
    requestListener = function(request, response) {
      var archive_args, archive_name, archive_process, check, death_room_found, duellog, error, filename, getpath, len3, len4, len5, len6, m, n, o, oppo_pos, p, parseQueryString, pass_validated, player, ref3, replay, room, roomsjson, u, win_pos;
