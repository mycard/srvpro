...
(function() {
  ...
  CLIENT_get_authorize_key = global.CLIENT_get_authorize_key = function(client) {
    ...
    } else if (settings.modules.mycard.enabled || settings.modules.tournament_mode.enabled || client.is_local) {
      return client.name;
    } else {
  ...
  ygopro.ctos_follow('JOIN_GAME', false, function(buffer, info, client, server, datas) {
    var check_buffer_indentity, create_room_with_action, len2, m, name, ref2, replay_id, room;
    //log.info info
