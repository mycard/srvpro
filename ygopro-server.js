...
(function() {
  // 标准库
  var CLIENT_get_authorize_key, CLIENT_kick, CLIENT_send_replays, ROOM_all, ROOM_bad_ip, ROOM_ban_player, ROOM_connected_ip, ROOM_find_by_name, ROOM_find_by_pid, ROOM_find_by_port, ROOM_find_by_title, ROOM_find_or_create_ai, ROOM_find_or_create_by_name, ROOM_find_or_create_random, ROOM_kick, ROOM_player_flee, ROOM_player_get_score, ROOM_player_lose, ROOM_player_win, ROOM_players_banned, ROOM_players_oppentlist, ROOM_players_scores, ROOM_unwelcome, ROOM_validate, Room, SERVER_kick, SOCKET_flush_data, _, _async, addCallback, auth, badwordR, badwords, ban_user, bunyan, chat_color, config, cppversion, crypto, date, default_config, default_data, dialogues, dns, duel_log, e, exec, execFile, fs, geoip, get_memory_usage, http, http_server, https, https_server, imported, j, k, l, len, len1, len2, lflists, list, loadJSON, load_dialogues, load_tips, log, memory_usage, merge, moment, net, oldbadwords, oldconfig, olddialogues, oldtips, options, os, path, plugin_filename, plugin_list, plugin_path, real_windbot_server_ip, ref, ref1, report_to_big_brother, request, requestListener, setting_change, setting_save, settings, spawn, spawnSync, spawn_windbot, tips, url, util, wait_room_start, windbot_looplimit, windbot_process, windbots, ygopro;
  ...
  ygopro.stoc_follow('GAME_MSG', true, function(buffer, info, client, server, datas) {
    var card, cpos, hint_type, l, len2, line, loc, msg, playertype, pos, ppos, reason, ref2, ref3, ref4, room, trigger_location, val;
    room = ROOM_all[client.rid];
    if (!room) {
      return;
    }
  ...
  for (l = 0, len2 = plugin_list.length; l < len2; l++) {
